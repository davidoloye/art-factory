export const NFTProgramId = 'leo_nft.aleo';

export const NFTProgram = `program leo_nft.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1rht02dwz5vxyxzt7hzvc2nka83y4lmt8k3hnxducn2gm29xkfq8qm6vqvc;
